...
namespace fsdfeas
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            listBox1.Location = new System.Drawing.Point(120, 120);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("bylo zadano 10 prvku, děkujeme za použití");
            }
            else
            {
    ...
    public partial class Form2 : Form
    {
        ...
        public Form2(ListBox listbox)
        {
            ...
            newButton2.Location = new System.Drawing.Point(50, 60);
            ...
            textboxicek.KeyDown += textboxicek_KeyDown;
            Controls.Add(textboxicek);
        }

        private void newButton_Click(object sender, EventArgs e)
        {
            if(neco.Items.Count == 10)
            {
                MessageBox.Show("bylo zadano 10 prvku, děkujeme za použití");
            }
            else
